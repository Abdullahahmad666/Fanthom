...
const TILE =
  "flex h-[88px] w-[178px] shrink-0 items-center justify-center rounded-xl bg-[#1c1c1c] text-fg";

export const BRAND_TILE = TILE;
...
export function HubSpotLogo() {
  return (
    <span className={TILE}>
      <span className="flex items-baseline text-[24px] font-bold tracking-tight">
        HubSp
        <svg viewBox="0 0 24 24" className="mx-[1px] h-[17px] w-[17px] self-center" aria-hidden>
...
export function AdobeLogo() {
  return (
    <span className={`${TILE} flex-col gap-1`}>
      ...
      <span className="text-[12px] font-semibold tracking-tight">Adobe</span>
    </span>
  );
}
...
export function GrubhubLogo() {
  return (
    <span className={`${TILE} gap-2`}>
      ...
      <span className="text-[20px] font-extrabold tracking-tight">GRUBHUB</span>
    </span>
  );
}
...
export function EaLogo() {
  return (
    <span className={TILE}>
      <svg viewBox="0 0 48 48" className="h-[42px] w-[42px]" aria-label="EA">
...
export function CalendlyLogo() {
  return (
    <span className={`${TILE} gap-2`}>
      ...
      <span className="text-[21px] font-medium tracking-tight">Calendly</span>
    </span>
  );
}
